...
import com.sanikapanika.ratelimiter.ThrottlingType;
import com.sanikapanika.ratelimiter.support.SpElEvaluator;
...
public class ThrottlingEvaluatorImpl implements ThrottlingEvaluator {
    ...
    public String evaluate(Throttling throttlingConfig, Object bean, Class clazz, Method method, Object[] args) {
        ...
        if (throttlingConfig.type().equals(ThrottlingType.SpEL) && !StringUtils.isEmpty(throttlingConfig.expression())) {
            try {
